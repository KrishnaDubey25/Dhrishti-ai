...
export interface UploadRecord{ id:string; name:string; type:string; size:number; dataUrl?:string; uploadedAt:string; source?:'patient'|'fundus-camera'|'camera'; }
...
export interface EyeScreening{ eye:'right'|'left'; image?:UploadRecord; quality:Quality; qualityScore?:number; enhancementApplied?:boolean; observations:ClinicalObservation; }
